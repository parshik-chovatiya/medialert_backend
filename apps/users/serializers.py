...
class PasswordResetRequestSerializer(serializers.Serializer):
    ...
    def validate_email(self, value):
        ...
        if not CustomUser.objects.filter(email=value).exists():
            ...
            # but in this case, we simply can accept it and fail silently in the view,
            # but raising validation error is also common. To follow the pattern, 
            # we will let the view handle silent failure or error based on requirements.
            pass
        return value
